    ...
    return (
        <div className="mt-6 flex justify-center">
            <EditModalProfile
                ...
                userId={user.uid}
            />
            <div className="border-2xl shadow-2xl flex mt-60  flex-col p-4 rounded tog">
                <div className="flex items-center mt-4 mb-4 justify-end">
                    ...
                    <div className="mb-2 flex-auto w-60 ml-4">
                        ...
                        >
                            <span className="  bg-blue-400  rounded-xl p-2 font-bold text-white">
                                Upload image
                            </span>
                            <input
                                ref={imageRef}
              ...
              <span>Full Name</span>
                ...
                <div className="flex mt-6">
                    ...
                    <div className="flex-auto w-60 ...">
                        { !loading ? (
                            <button
                                className="bg-blue-400 font-bold text-sm rounded-xl text-white w-20 h-8"
