...
const ForgotPassword = () => {
  ...
  return (
    <div className="bg-gray-100 h-screen w-screen flex flex-wrap items-center justify-center p-3">
      <Helmet>
          ...
          <form onSubmit={handleSubmit} className="" method="post">
            ...
            <div>
              <button
                disabled={isInvalid}
                type="submit"
                className={`bg-blue-400 text-sm mt-3 cursor-pointer text-white rounded-md w-full h-8 font-medium ${
            ...
            <div className="flex justify-center items-center flex-col w-full bg-white">
              <p className="text-sm">
                <Link
                  to={LOGIN}
                  className="font-semibold text-brand text-blue-400"
                >
                  Login
                </Link>
              </p>
