...
const ConfirmCreatePost = ({ image, back }) => {
    ...
    return (
        ...
        <div className=" items justify-center">
            <div className=" p-60 border items justify-center" style={{height: 500, width:600}}>
                <div>
            ...
            <div className="w-72 p-4 flex flex-col justify-between">
                ...
                {loading ? (
                    ...
                    <div className="flex justify-end" onClick={handleSubmit}>
                        <button className="bg-blue-400 mt-5 font-bold text-sm rounded text-white w-full h-8" id='addBtn'>Add</button>
                    </div>
                )}
            </div>
        </div>
