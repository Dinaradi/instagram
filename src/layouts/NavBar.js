                ...
                <div className="w-60">
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            className="bg-gray-100 text-gray-700 text-sm rounded-3xl w-full px-4 py-2"
                            placeholder="Search"
                        />
                    </div>
                    {focused && (
                ...
                <div>
                    ...
                    <div className="flex">
                        ...
                        <div className='p-2 mt-6 mr-2 h-90'>
                            ...
                            <div className="mt-5 cursor-pointer flex items-center justify-center"
                            ...
                            <div
                                        id = 'imgProfile'
                                className="mt-7 rounded-full border-2 border-rose-600 cursor-pointer flex items-center justify-center w-8 h-8 relative select-none"
